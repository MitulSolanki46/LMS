...
<body style="background-image:url('images/design1.png');background-size: cover;background-repeat: no-repeat;">
<div id="banner">
...
<td><a href="issue1.php" class="Command">Check status</a></td>
